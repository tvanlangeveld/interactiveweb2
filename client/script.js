...
function changeBackGround(){
    sayHelloButton.classList.add("colorChange")
}
...
function colorBack(){
    sayHelloButton.classList.remove("colorChange")
}
...
let textRepeat = document.querySelector('#repeat-text')
...
const repeatMyParam = () => {
    ...
    textRepeat.textContent = response.data.style.display = 'block'
